function create_button_menu_devices(x, y, _sprite, _action) { //Função para criar botões dentro do menu de opções
...
function create_button_game_devices(x, y, _panel, _sprite, _action) { //Função para criar botões dentro do jogo
    var _x1 = x - sprite_get_width(_sprite) / 2;
    var _y1 = y - sprite_get_height(_sprite) / 2;
    var _x2 = x + sprite_get_width(_sprite) / 2;
    var _y2 = y + sprite_get_height(_sprite) / 2;
